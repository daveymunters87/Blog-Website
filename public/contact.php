<div class="flex min-h-screen h-100 items-center justify-start bg-white">
  <div class="mx-auto w-full max-w-lg">
    <h1 class="text-4xl font-medium">Contact Me</h1>
    <p class="mt-3">Email me by using the Form below:</p>

    <form action="https://api.web3forms.com/submit" method="POST" class="mt-10">
      <input type="hidden" name="access_key" value="0a1a98cf-e28b-4189-8657-8725eb66c9a6" /> 
